...
";
        ...
        public static Encoding EncodingDefault(string _name)
        {
            if (_name == null)
                return _ENCODING;
        ...
        public static void EncodingDefault(ref Encoding _ref)
        {
            if (_ref == null)
                _ref = _ENCODING;
        }

        public static void NoBOMEncodingDefault(ref Encoding _ref)
        {
            if (_ref == null)
