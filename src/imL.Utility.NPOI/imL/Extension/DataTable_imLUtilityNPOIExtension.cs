...
namespace imL.Utility.NPOI
{
    public static class DataTable_imLUtilityNPOIExtension
    {
        public static void ExcelCreate(this DataTable _this,
            string _path,
            bool _columnnames = true,
            bool _xls = true,
            IProgress<int> _progress = null)
        {
            _this.GetExcel(out Stream _out, _columnnames, _xls, _progress);
            _out.FileCreate(_path);
            _out.Dispose();
        }
        public static void GetExcel(this DataTable _this,
            out Stream _out,
            bool _columnnames = true,
            bool _xls = true,
            IProgress<int> _progress = null)
        {
            ...
            ISheet _wbs = _wb.CreateSheet(_this.TableName);
            ...
            if (_columnnames)
            {
                ...
                foreach (DataColumn _dc in _this.Columns)
                {
            ...
            foreach (DataRow _dr in _this.Rows)
            {
                _col = 0;
                _wbsr = _wbs.CreateRow(_row);
                foreach (DataColumn _dc in _this.Columns)
        ...
        public static void ExcelCreate(this DataTable _this,
            ...
            IProgress<int> _progress = null)
        {
            _this.GetExcel(out Stream _out, _formats, _columnnames, _xls, _progress);
            _out.FileCreate(_path);
            _out.Dispose();
        }
        public static void GetExcel(this DataTable _this,
            ...
            IProgress<int> _progress = null)
        {
            ...
            _col = 0;
            ICellStyle[] _t_styles = new ICellStyle[_this.Columns.Count];
            foreach (DataColumn _dc in _this.Columns)
            {
                Tuple<string, string, string> _f = _formats.Where(_w => _w.Item1 == _this.TableName && _w.Item2 == _dc.ColumnName).FirstOrDefault();
