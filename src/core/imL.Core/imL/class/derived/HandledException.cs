...
namespace imL
{
    ...
    public class HandledException : Exception
    {
        ...
        public HandledException(string? _code, string? _message) : base(_message) { _CODE = _code; }
        public HandledException(string? _code, string? _message, Exception? _inner) : base(_message, _inner) { _CODE = _code; }
    }
}
