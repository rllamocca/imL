...
namespace RichieSays
{
    ...
    {
        public static void Start(string[] _args, bool _throw = false)
        {
            try
            {
                ...
                using (Progress32 _pb = new(_paths.Length))
                {
                ...
                using (Progress32 _pb = new(_list.Count))
                {
